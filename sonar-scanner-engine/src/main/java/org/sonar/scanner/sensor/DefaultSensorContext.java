...
public class DefaultSensorContext implements SensorContext {
  ...
  public NewCoverage newCoverage() {
    if (branchConfiguration.isShortLivingBranch() || branchConfiguration.isPullRequest()) {
  ...
  public NewCpdTokens newCpdTokens() {
    if (analysisMode.isIssues() || branchConfiguration.isShortLivingBranch() || branchConfiguration.isPullRequest()) {
